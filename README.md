...
Stage 11 hostile audit previously reopened Stage 7R only for the general-technology P2R formulation. That defect was repaired and refrozen as v3 without changing the quadratic baseline or Proposition 4. The repeated Stage 11R hostile referee gate now returns `GO TO JOURNAL POSITIONING`.
...
Stage 12 must position the surviving contribution as it stands and must not redesign the theory merely to fit a preferred journal.
