...
The main policy result is a complete-to-selective standardization reversal. With any fixed positive symmetric common-R&D allocation, and also when the regulator coordinates the symmetric R&D composition while Bertrand pricing remains decentralized, complete standardization is optimal. With decentralized endogenous R&D composition, however, sufficiently strong product-market rivalry yields a unique interior standardization scope in the quadratic baseline. The paper derives the exact rivalry threshold separating complete and selective standardization regimes.

The paper is positioned narrowly relative to the closest literatures. Llanes (2024, *International Journal of Industrial Organization*) studies incentives to develop technologies for inclusion in technical standards and associated standard-setting institutions. Acemoglu, Gancia, and Zilibotti (2012) already establish a broader constrained-standardization result, while Bryan and Lemus (2017) establish that scarce research resources and underappropriation can distort the direction of innovation. The contribution claimed here is therefore not that standards affect innovation, that innovation direction is endogenous, or that partial standardization may be optimal. It is the specific regulator-chosen scope → common/proprietary portfolio reallocation → policy-reversal mechanism and its threshold characterization in a differentiated-products IO environment.
